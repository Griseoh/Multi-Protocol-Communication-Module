...
set_property -dict {PACKAGE_PIN M19 IOSTANDARD LVCMOS33} [get_ports load]

##RGB LEDs

set_property -dict {PACKAGE_PIN L15 IOSTANDARD LVCMOS33} [get_ports utdone]
set_property -dict {PACKAGE_PIN G17 IOSTANDARD LVCMOS33} [get_ports i2cs_done]
set_property -dict {PACKAGE_PIN N15 IOSTANDARD LVCMOS33} [get_ports i2c_ack_err]
set_property -dict {PACKAGE_PIN G14 IOSTANDARD LVCMOS33} [get_ports urdone]
set_property -dict {PACKAGE_PIN L14 IOSTANDARD LVCMOS33} [get_ports i2cm_done]
set_property -dict {PACKAGE_PIN M15 IOSTANDARD LVCMOS33} [get_ports i2c_master_busy]

##LEDs

set_property -dict {PACKAGE_PIN R14    IOSTANDARD LVCMOS33 } [get_ports { no_load }];
...
set_property -dict {PACKAGE_PIN D19 IOSTANDARD LVCMOS33} [get_ports i2c_op]
...
set_property -dict {PACKAGE_PIN Y18 IOSTANDARD LVCMOS33} [get_ports {rcvd_dat[0]}]
set_property -dict {PACKAGE_PIN Y19 IOSTANDARD LVCMOS33} [get_ports {rcvd_dat[1]}]
set_property -dict {PACKAGE_PIN Y16 IOSTANDARD LVCMOS33} [get_ports {rcvd_dat[2]}]
set_property -dict {PACKAGE_PIN Y17 IOSTANDARD LVCMOS33} [get_ports {rcvd_dat[3]}]
set_property -dict {PACKAGE_PIN U18 IOSTANDARD LVCMOS33} [get_ports {rcvd_dat[4]}]
set_property -dict {PACKAGE_PIN U19 IOSTANDARD LVCMOS33} [get_ports {rcvd_dat[5]}]
set_property -dict {PACKAGE_PIN W18 IOSTANDARD LVCMOS33} [get_ports {rcvd_dat[6]}]
set_property -dict {PACKAGE_PIN W19 IOSTANDARD LVCMOS33} [get_ports {rcvd_dat[7]}]

##PmodB

set_property -dict {PACKAGE_PIN W14 IOSTANDARD LVCMOS33} [get_ports {i2c_read_dat[0]}]
set_property -dict {PACKAGE_PIN Y14 IOSTANDARD LVCMOS33} [get_ports {i2c_read_dat[1]}]
set_property -dict {PACKAGE_PIN T11 IOSTANDARD LVCMOS33} [get_ports {i2c_read_dat[2]}]
set_property -dict {PACKAGE_PIN T10 IOSTANDARD LVCMOS33} [get_ports {i2c_read_dat[3]}]
set_property -dict {PACKAGE_PIN V16 IOSTANDARD LVCMOS33} [get_ports {i2c_read_dat[4]}]
set_property -dict {PACKAGE_PIN W16 IOSTANDARD LVCMOS33} [get_ports {i2c_read_dat[5]}]
set_property -dict {PACKAGE_PIN V12 IOSTANDARD LVCMOS33} [get_ports {i2c_read_dat[6]}]
set_property -dict {PACKAGE_PIN W13 IOSTANDARD LVCMOS33} [get_ports {i2c_read_dat[7]}]
...
set_property -dict {PACKAGE_PIN T14 IOSTANDARD LVCMOS33} [get_ports {spi_mode[0]}]
set_property -dict {PACKAGE_PIN U12 IOSTANDARD LVCMOS33} [get_ports {spi_mode[1]}]
set_property -dict {PACKAGE_PIN U13 IOSTANDARD LVCMOS33} [get_ports {p_dat[0]}]
set_property -dict {PACKAGE_PIN V13 IOSTANDARD LVCMOS33} [get_ports {p_dat[1]}]
set_property -dict {PACKAGE_PIN V15 IOSTANDARD LVCMOS33} [get_ports {p_dat[2]}]
set_property -dict {PACKAGE_PIN T15 IOSTANDARD LVCMOS33} [get_ports {p_dat[3]}]
set_property -dict {PACKAGE_PIN R16 IOSTANDARD LVCMOS33} [get_ports {p_dat[4]}]
set_property -dict {PACKAGE_PIN U17 IOSTANDARD LVCMOS33} [get_ports {p_dat[5]}]
set_property -dict {PACKAGE_PIN V17 IOSTANDARD LVCMOS33} [get_ports {p_dat[6]}]
set_property -dict {PACKAGE_PIN V18 IOSTANDARD LVCMOS33} [get_ports {p_dat[7]}]
set_property -dict {PACKAGE_PIN T16 IOSTANDARD LVCMOS33} [get_ports {prot_sel[0]}]
set_property -dict {PACKAGE_PIN R17 IOSTANDARD LVCMOS33} [get_ports {prot_sel[1]}]
set_property -dict {PACKAGE_PIN P18 IOSTANDARD LVCMOS33} [get_ports {i2c_addr[6]}]
...
set_property -dict {PACKAGE_PIN Y11 IOSTANDARD LVCMOS33} [get_ports {i2c_addr[0]}]
set_property -dict {PACKAGE_PIN Y12 IOSTANDARD LVCMOS33} [get_ports {i2c_addr[1]}]
set_property -dict {PACKAGE_PIN W11 IOSTANDARD LVCMOS33} [get_ports {i2c_addr[2]}]
set_property -dict {PACKAGE_PIN V11 IOSTANDARD LVCMOS33} [get_ports {i2c_addr[3]}]
set_property -dict {PACKAGE_PIN T5 IOSTANDARD LVCMOS33} [get_ports {i2c_addr[4]}]
set_property -dict {PACKAGE_PIN U10 IOSTANDARD LVCMOS33} [get_ports {i2c_addr[5]}]
...
# Inputs
set_false_path -from [get_ports {{i2c_addr[*]} {p_dat[*]} {spi_mode[*]} {prot_sel[*]}}]
set_false_path -from [get_ports {i2c_op load rst}]

set_false_path -to [get_ports {i2c_ack_err i2cm_done i2cs_done i2c_master_busy urdone utdone}]
set_false_path -to [get_ports {{rcvd_dat[*]} {i2c_read_dat[*]}}]

set_switching_activity -toggle_rate 0.000 -static_probability 0.000 [get_nets spiprot/spg/buf_start]
